...
## 🧠 AI Knowledge Base (MANDATORY - Check BEFORE Answering)

**Effective Date**: 30. Dezember 2025  
**Rule**: When trigger keywords appear → READ the linked file FIRST

### 🔍 Trigger Keywords → File Lookup

| User Asks About... | READ THIS FIRST |
|-------------------|-----------------|
| **Models, LLM, Claude, GPT, Gemini, Grok** | [docs/ai/COPILOT_MODELS_REFERENCE.md](../docs/ai/COPILOT_MODELS_REFERENCE.md) |
| **C# 14, extension members, field keyword** | [docs/ai/C#14_FEATURES_REFERENCE.md](../docs/ai/C#14_FEATURES_REFERENCE.md) |
| **daisyUI, UI components, Tailwind** | [docs/ai/DAISYUI_V5_COMPONENTS_REFERENCE.md](../docs/ai/DAISYUI_V5_COMPONENTS_REFERENCE.md) |
| **Agent YAML, .agent.md, frontmatter** | [docs/ai/COPILOT_AGENT_DEFINITION.md](../docs/ai/COPILOT_AGENT_DEFINITION.md) |
| **Dependencies, packages, versions** | [docs/ai/DEPENDENCY_DOCUMENTATION_INDEX.md](../docs/ai/DEPENDENCY_DOCUMENTATION_INDEX.md) |

### 📊 Quick Facts (Memorized)

**GitHub Copilot Models** (Dec 2025): 17+ models from OpenAI, Anthropic, Google, xAI
...
**B2Connect Stack**: .NET 10, Vue 3.5, Tailwind 4.1, daisyUI 5.5, Wolverine

### ⚠️ DO NOT Answer These Without Checking docs/ai/

- ❌ "What models does Copilot support?" → Check COPILOT_MODELS_REFERENCE.md
- ❌ "What's new in C# 14?" → Check C#14_FEATURES_REFERENCE.md
- ❌ "How do I use daisyUI components?" → Check DAISYUI_V5_COMPONENTS_REFERENCE.md

### 📁 Full Index

For complete documentation: **[docs/ai/INDEX.md](../docs/ai/INDEX.md)** (mandatory lookup table)

**Last updated**: 30. Dezember 2025 | **Token Optimization**: 3,578 → 1,200 lines | **Knowledge Graph**: docs/ai/INDEX.md added
