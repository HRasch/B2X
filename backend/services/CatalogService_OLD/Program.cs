...
// ==================== ELASTICSEARCH SETUP ====================
// Register Elasticsearch client for search functionality
...
builder.Services.AddSingleton<B2Connect.CatalogService.Infrastructure.IElasticsearchClient>(
    new B2Connect.CatalogService.Infrastructure.ElasticsearchClientWrapper(elasticsearchClient));
