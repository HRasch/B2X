...
builder.Services.AddScoped<B2X.Shared.Infrastructure.Authorization.ITenantSettingsAccessor, B2X.Store.Authorization.TenantSettingsAccessor>();
builder.Services.AddScoped<B2X.Shared.Infrastructure.Authorization.IUserPermissionAccessor, B2X.Store.Authorization.UserPermissionAccessor>();
builder.Services.AddScoped<B2X.Shared.Infrastructure.Authorization.IRolePermissionAccessor, B2X.Store.Authorization.RolePermissionAccessor>();
