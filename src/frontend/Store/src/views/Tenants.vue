<template>
  <div class="tenants">
    ...
    <div v-if="loading" class="loading">{{ $t('tenants.loading') }}</div>
    ...
    <div v-else class="tenants-list">
      <div v-for="tenant in tenants" :key="tenant.id" class="tenant-card">
        ...
        <div class="tenant-actions">
          <button class="btn btn-small">{{ $t('tenants.actions.edit') }}</button>
          <button class="btn btn-small btn-danger">{{ $t('tenants.actions.delete') }}</button>
        </div>
      </div>
    </div>
