  ...
  <div class="cart-container">
    ...
    <div v-else class="cart-content">
      ...
      <div class="cart-summary">
        ...
        <div class="summary-row">
          <span>{{ $t('cart.summary.tax', { rate: 19 }) }}</span>
          <span>{{ tax.toFixed(2) }}€</span>
        </div>

        <!-- Shipping Selector (PAngV Compliance) -->
        <div class="shipping-section">
          <h3>{{ $t('cart.shipping.title') }}</h3>
          <div class="shipping-info">
            <label for="country">{{ $t('cart.shipping.destination') }}</label>
            <select v-model="selectedCountry" id="country" @change="onCountryChange">
              <option value="">{{ $t('cart.shipping.selectCountry') }}</option>
              <option value="DE">{{ $t('cart.shipping.countries.de') }}</option>
              <option value="AT">{{ $t('cart.shipping.countries.at') }}</option>
              <option value="BE">{{ $t('cart.shipping.countries.be') }}</option>
              <option value="FR">{{ $t('cart.shipping.countries.fr') }}</option>
              <option value="NL">{{ $t('cart.shipping.countries.nl') }}</option>
              <option value="CH">{{ $t('cart.shipping.countries.ch') }}</option>
              <option value="GB">{{ $t('cart.shipping.countries.gb') }}</option>
            </select>
          </div>
        ...
        <button @click="checkout" class="checkout-btn">{{ $t('cart.actions.checkout') }}</button>
