...
<template>
  <div class="min-h-screen bg-base-100">
    ...
    <nav class="breadcrumbs text-sm px-4 py-4 max-w-7xl mx-auto">
      <ul>
        <li>
          <router-link to="/">{{ t('productDetail.breadcrumb.home') }}</router-link>
        </li>
        <li>
          <router-link to="/products">{{ t('productDetail.breadcrumb.products') }}</router-link>
        </li>
    ...
    <div v-if="loading" class="flex justify-center items-center py-24">
      <div class="flex flex-col items-center gap-4">
        ...
        <p class="text-base-content/70">{{ t('productDetail.loading.message') }}</p>
      </div>
    </div>
    ...
    <div v-else-if="error" class="max-w-7xl mx-auto px-4 py-8">
      <div class="alert alert-error">
        ...
        <button @click="loadProduct" class="btn btn-sm btn-ghost">
    ...
    <div v-else-if="product" class="max-w-7xl mx-auto px-4 py-8">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div class="card bg-green-50 border-l-4 border-green-500 shadow-sm mb-6">
            <div class="card-body">
              <h3 class="card-title text-base mb-4">{{ t('productDetail.price.overview') }}</h3>
              ...
              <p class="text-xs text-gray-500 mt-3">
                {{ t('productDetail.price.vatNotice') }}
              </p>
            </div>
          </div>
          ...
          >
            ...
            <span v-if="product.inStock && product.stockQuantity" class="text-sm ml-2">
              {{ t('productDetail.stock.available', { count: product.stockQuantity }) }}
            </span>
          </div>
          ...
          <div class="flex gap-4 mb-6">
            ...
            >
              ...
              <span v-else>{{ t('productDetail.actions.addToCart') }}</span>
            </button>
          </div>
          ...
          <div class="flex gap-2 items-center pt-4 border-t border-base-300">
            <span class="text-sm text-base-content/70">{{ t('productDetail.share.label') }}</span>
      ...
      <div v-if="product.specifications" class="mt-12">
        <h2 class="text-2xl font-bold mb-6">{{ t('productDetail.specifications.title') }}</h2>
      ...
      <div v-if="reviews.length > 0" class="mt-12">
        <h2 class="text-2xl font-bold mb-6">{{ t('productDetail.reviews.title') }}</h2>
              ...
              <div class="flex justify-between items-start">
                <div>
                  ...
                  <p class="text-sm text-base-content/70">
                    {{ t('productDetail.reviews.byAuthor', { author: review.author }) }}
