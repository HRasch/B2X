...
test.describe('Entity Localization API', () => {
  ...
  test.describe('GET /entity-localization/{entityId}', () => {
    test('should retrieve all localized properties for an entity', async () => {
      const response = await request.get(`${API_BASE}/entity-localization/${ENTITY_ID}`);
  ...
  test.describe('GET /entity-localization/{entityId}/{propertyName}', () => {
    test('should retrieve all translations for a property', async () => {
      const response = await request.get(`${API_BASE}/entity-localization/${ENTITY_ID}/Name`);
      expect([200, 404]).toContain(response.status());
  ...
  test.describe('GET /entity-localization/{entityId}/{propertyName}/{language}', () => {
    test('should retrieve translation for specific language', async () => {
      const response = await request.get(`${API_BASE}/entity-localization/${ENTITY_ID}/Name/en`);
      expect([200, 404]).toContain(response.status());
    ...
    test('should return 404 for non-existent translation', async () => {
      const response = await request.get(`${API_BASE}/entity-localization/${ENTITY_ID}/Name/xx`);
      expect([404, 200]).toContain(response.status());
    });
  });
  ...
  test.describe('POST /entity-localization/{entityId}/{propertyName}', () => {
    test('should require authentication', async ({ request }) => {
      const response = await request.post(`${API_BASE}/entity-localization/${ENTITY_ID}/Name`, {
        headers: { tenant: TENANT_ID },
  ...
  test.describe('PUT /entity-localization/{entityId}/{propertyName}', () => {
    test('should require admin role', async ({ request }) => {
      const response = await request.put(`${API_BASE}/entity-localization/${ENTITY_ID}/Name`, {
        headers: { tenant: TENANT_ID },
        data: {
          en: 'Product Name',
          de: 'Produktname',
  ...
  test.describe('Error Handling & Edge Cases', () => {
    test('should handle invalid entity ID format', async () => {
      const response = await request.get(`${API_BASE}/entity-localization/invalid-uuid/Name`);
  ...
  test.describe('Performance Tests', () => {
    ...
    test('should handle rapid successive requests', async () => {
      const requests = Array(10)
        .fill(null)
        .map(() => request.get(`${API_BASE}/entity-localization/${ENTITY_ID}`));
