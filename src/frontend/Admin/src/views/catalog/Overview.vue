  ...
  <div class="catalog-overview">
    ...
    <div class="quick-actions">
      ...
      <div class="actions-grid">
        ...
        <router-link to="/catalog/import" class="action-card">
          <div class="action-icon">📤</div>
          <div class="action-title">{{ $t('catalog.overview.importCatalog') }}</div>
          <div class="action-description">{{ $t('catalog.overview.importCatalogDesc') }}</div>
        </router-link>
      </div>
    </div>
