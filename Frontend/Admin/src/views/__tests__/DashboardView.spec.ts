...
describe('DashboardView.vue (Full Dashboard)', () => {
    ...
    it('should render main layout wrapper', () => {
      const wrapper = mount(DashboardView, {
        global: {
          plugins: [router, pinia],
          stubs: {
            'MainLayout': { template: '<div data-test="main-layout-stub"><slot /></div>' },
            'DashboardCard': true,
            'DashboardChart': true,
            'StatCard': true
          }
  ...
  describe('Data Loading', () => {
    ...
    it('should handle error state', async () => {
      ...
      // Simulate error
      await wrapper.setData({ hasError: true, errorMessage: 'Failed to load data' })
      await wrapper.vm.$nextTick()
    ...
    it('should handle stat card clicks', async () => {
      const wrapper = mount(DashboardView, {
        global: {
          ...
          stubs: {
            'MainLayout': true,
            'DashboardCard': { template: '<div data-test="stat-card" @click="$emit(\'click\')" />' },
            'DashboardChart': true,
            'StatCard': true
          }
        }
  ...
  describe('Accessibility', () => {
    ...
    it('should have ARIA labels on sections', () => {
      ...
      const statsSection = wrapper.find('[data-test="stats-section"]')
      expect(
        statsSection.attributes('role') ||
        statsSection.attributes('aria-label')
      ).toBeTruthy()
    })
