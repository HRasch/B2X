...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'gradient-soft-cyan': 'linear-gradient(135deg, #0ea5e9 0%, #06b6d4 100%)',
        'gradient-soft-blue': 'linear-gradient(135deg, #3b82f6 0%, #0284c7 100%)',
        'gradient-soft-purple': 'linear-gradient(135deg, #8b5cf6 0%, #6d28d9 100%)',
