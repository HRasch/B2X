    ...
    <div class="max-w-md mx-auto bg-white rounded-lg shadow-lg p-8">
      ...
      <form @submit.prevent="submitForm" class="space-y-5" novalidate>
        ...
        <div>
          ...
          >
            <option value="">
              {{ $t('privateCustomerRegistration.form.country.options.select') }}
            </option>
            <option value="DE">
              {{ $t('privateCustomerRegistration.form.country.options.DE') }}
            </option>
            <option value="AT">
              {{ $t('privateCustomerRegistration.form.country.options.AT') }}
            </option>
            <option value="CH">
              {{ $t('privateCustomerRegistration.form.country.options.CH') }}
            </option>
            <option value="FR">
              {{ $t('privateCustomerRegistration.form.country.options.FR') }}
            </option>
            <option value="NL">
              {{ $t('privateCustomerRegistration.form.country.options.NL') }}
            </option>
            <option value="BE">
              {{ $t('privateCustomerRegistration.form.country.options.BE') }}
            </option>
            <option value="LU">
              {{ $t('privateCustomerRegistration.form.country.options.LU') }}
            </option>
            <option value="PL">
              {{ $t('privateCustomerRegistration.form.country.options.PL') }}
            </option>
            <option value="CZ">
              {{ $t('privateCustomerRegistration.form.country.options.CZ') }}
            </option>
          </select>
          <p
            v-if="errors.country"
