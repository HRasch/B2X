...
describe("OpenTelemetry Instrumentation Configuration", () => {
  ...
  describe("Instrumentation Configuration", () => {
    it("should disable filesystem instrumentation", () => {
      ...
      expect(
        instrumentationConfig["@opentelemetry/instrumentation-fs"].enabled
      ).toBe(false);
    });
    ...
    it("should disable DNS instrumentation", () => {
      ...
      expect(
        instrumentationConfig["@opentelemetry/instrumentation-dns"].enabled
      ).toBe(false);
    });
    ...
    it("should enable HTTP instrumentation", () => {
      ...
      expect(
        instrumentationConfig["@opentelemetry/instrumentation-http"].enabled
      ).toBe(true);
    });
    ...
    it("should enable fetch instrumentation", () => {
      ...
      expect(
        instrumentationConfig["@opentelemetry/instrumentation-fetch"].enabled
      ).toBe(true);
    });
  });
});
