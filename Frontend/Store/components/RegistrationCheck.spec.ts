...
describe('RegistrationCheck.vue', () => {
  ...
  it('renders registration check form', async () => {
    ...
    expect(wrapper.find('[data-testid="business-type-select"]').exists()).toBe(true);
  ...
  it('shows success message on successful registration check', async () => {
    ...
    vi.mocked(registrationService.checkRegistrationType).mockResolvedValueOnce(mockResponse);
    ...
    await wrapper.find('[data-testid="email-input"]').setValue('max@example.com');
    await wrapper.find('[data-testid="business-type-select"]').setValue('B2B');
  ...
  it('shows error message on API error', async () => {
    ...
    vi.mocked(registrationService.checkRegistrationType).mockRejectedValueOnce(mockError);
