...
**Estimated Effort:** 21 Story Points (~ 3-4 Sprints)
  - **Sprint 1 (KW 1-2):** 13 Story Points (Original Registration Flow)
  - **Sprint 2 (KW 2-3):** 8 Story Points (Existing Customer Simplified Registration)
...
- [ ] Backend:
  ...
  - [ ] Implement ERP lookup service (SAP/CSV)
...
- Business customers skip existing customer check (B2C only)
