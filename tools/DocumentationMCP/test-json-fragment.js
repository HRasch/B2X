...
// Wait for tools/list response, then test extract_json_fragment
setTimeout(() => {
  const testRequest = {
    jsonrpc: '2.0',
    id: 3,
    ...
    params: {
      ...
      arguments: {
        filePath: 'AppHost/appsettings.json',
        workspacePath: 'c:\\Users\\Holge\\repos\\B2Connect',
        maxKeys: 20,
        schemaPath: 'AppHost/appsettings.schema.json',
        prioritizeBySchema: true,
