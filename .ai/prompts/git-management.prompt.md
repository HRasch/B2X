...
- [ ] **ONE TASK PER PR**: This PR solves exactly ONE issue/feature/task

#### PR Content Rules
- 🔒 **Nur eine gelöste Aufgabe pro PR** (Only one solved task per PR)
- ✅ Single cohesive topic - all changes relate to ONE feature/fix/task
- ❌ Multiple unrelated topics - split into separate PRs
- ⚠️ Multiple related components - provide justification (e.g., feature + tests + docs)
