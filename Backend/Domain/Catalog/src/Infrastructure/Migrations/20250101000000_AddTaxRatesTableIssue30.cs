...
namespace B2Connect.CatalogService.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    standard_vat_rate = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
                    reduced_vat_rate = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "tax_rates",
                columns: new[] { "id", "country_code", "standard_vat_rate", "reduced_vat_rate", "effective_date", "created_at", "updated_at" },
                values: new object[,]
                {
