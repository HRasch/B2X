// -----------------------------------------------------------------------------
// B2Connect Architecture Tests - Shared Test Base
...
{
    /// <summary>
    /// The loaded architecture containing all B2Connect domain assemblies.
    ...
    protected static readonly ArchUnitDomain.Architecture Architecture = new ArchLoader()
        .LoadAssemblies(
            ...
            typeof(B2Connect.AuthService.Data.AppUser).Assembly,                // Identity (AuthService namespace)
            ...
            typeof(B2Connect.Types.Domain.Entity).Assembly)                     // Shared Kernel
        .Build();
