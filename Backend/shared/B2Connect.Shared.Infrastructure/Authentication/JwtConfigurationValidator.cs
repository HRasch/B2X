...
namespace B2Connect.Shared.Infrastructure.Authentication;
    ...
    private List<JwtValidationError> ValidateIssuer()
    {
        ...
        if (string.IsNullOrWhiteSpace(issuer))
        {
            errors.Add(new JwtValidationError
            {
                ...
                Severity = ValidationSeverity.Critical,
                Remediation = "Set 'Jwt:Issuer' to identify the token issuer (e.g., 'B2Connect' or service URL)."
            });
            return errors;
        }
        ...
        else if (!IsValidServiceName(issuer))
        {
            errors.Add(new JwtValidationError
            {
                ...
                Severity = ValidationSeverity.Warning,
                Remediation = "Use a valid URI (e.g., 'https://auth.b2connect.com') or service name (e.g., 'B2Connect.Auth')."
            });
        }
    ...
    private List<JwtValidationError> ValidateAudience()
    {
        ...
        if (string.IsNullOrWhiteSpace(audience))
        {
            errors.Add(new JwtValidationError
            {
                ...
                Severity = ValidationSeverity.Critical,
                Remediation = "Set 'Jwt:Audience' to specify intended token recipients (e.g., 'B2Connect.API' or service URL)."
            });
            return errors;
        }
