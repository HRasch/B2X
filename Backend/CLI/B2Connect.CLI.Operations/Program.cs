...
using B2Connect.CLI.Operations.Commands.HealthCommands;
...
var rootCommand = new RootCommand("B2Connect Operations CLI - Platform Management Tool")
{
...
static async Task ShowInfo()
{
    ...
    AnsiConsole.Write(
        new Panel(
            "[bold]B2Connect Operations CLI Configuration[/]\n" +
            $"[green]Status:[/] Ready\n" +
