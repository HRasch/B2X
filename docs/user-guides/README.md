...
Access guides to help you with:
...
Zugriff auf Anleitungen zur Unterstützung:
- Kontoerstellung und -einrichtung
- Anmeldung bei Ihrem Konto
- Passwort zurücksetzen und Kontosicherheit
- Zwei-Faktor-Authentifizierung
- Sicherheits-Best-Practices
- Fehlerbehebung bei häufigen Problemen

**👉 [Deutsche Benutzerhandbuch öffnen](./de/)**

---

## 📚 Available Guides (All Languages)
...
### English Version (./en/)
- **getting-started.md** - First time? Start here!
- **login.md** - How to access your account
- **reset-password.md** - Forgot your password?
- **account-security.md** - Keep your account safe
...
- **README.md** - Vollständiger Anleitung-Index und FAQ

---

## ✨ Features of These Guides

- ✅ **Non-Technical Language** - Written for all users, no IT jargon
- ✅ **Step-by-Step Instructions** - Easy to follow procedures
- ✅ **Troubleshooting Sections** - Solutions to common problems
- ✅ **Security Tips** - Keep your account and data safe
- ✅ **FAQ Sections** - Answers to common questions
- ✅ **Mobile Friendly** - Works on all devices
- ✅ **Regularly Updated** - Current and accurate information
...
- All guides are public documentation
- No personal information collected
- HTTPS encryption for website
- GDPR compliant
...
- Initial release with English & German guides
- 4 core guides per language
- Complete FAQ & troubleshooting sections
