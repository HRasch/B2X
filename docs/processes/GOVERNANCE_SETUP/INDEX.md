# Governance Setup Reference

This directory contains setup documentation from the Governance Implementation Phase (Dec 2025).
...
- See: [/docs/archive/processes/GOVERNANCE_SETUP_2025_12_30/](../archive/processes/GOVERNANCE_SETUP_2025_12_30/)

## 📖 Role-based Documentation
For role-specific guidance:
- See: [/docs/by-role/](../../by-role/)
