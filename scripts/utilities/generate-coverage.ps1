...
Write-Host "📁 Reports available in: reports/test-results/coverage-report/" -ForegroundColor Cyan
Write-Host "🌐 Open reports/test-results/coverage-report/index.html in your browser" -ForegroundColor Cyan

# Display summary
$summaryPath = "reports/test-results/coverage-report/Summary.txt"
