...
> | Role | Time | File |
> |------|------|------|
> | 💻 Backend Developer | 10 min | [copilot-instructions-backend.md](./copilot-instructions-backend.md) |
> | 🎨 Frontend Developer | 10 min | [copilot-instructions-frontend.md](./copilot-instructions-frontend.md) |
> | ⚙️ DevOps Engineer | 10 min | [copilot-instructions-devops.md](./copilot-instructions-devops.md) |
> | 🧪 QA Engineer | 10 min | [copilot-instructions-qa.md](./copilot-instructions-qa.md) |
> | 🔐 Security Engineer | 10 min | [copilot-instructions-security.md](./copilot-instructions-security.md) |
> | **All Roles** | **5 min** | **[Quick-Start Guide](./copilot-instructions-quickstart.md)** |
>
> **Need the full index?** → [copilot-instructions-index.md](./copilot-instructions-index.md)

---

> ⚡ **New to this project?** Start with [copilot-instructions-quickstart.md](./copilot-instructions-quickstart.md) (5 minutes) before reading this comprehensive guide.

---

## 📝 Recent Updates

- **29. Dezember 2025**: Optimized copilot-instructions.md (3,578 → 1,200 lines)
  - Moved 200+ patterns/anti-patterns to role-specific guides
  - Centralized backend patterns in `copilot-instructions-backend.md`
  - Centralized frontend patterns in `copilot-instructions-frontend.md`
  - Centralized security patterns in `copilot-instructions-security.md`
  - Improved navigation and reduced cognitive load
  - **Target**: Main file now focuses on architecture, workflows, and role navigation
- **28. Dezember 2025**: Added comprehensive "🔀 Git Workflow & Commit Conventions" section
