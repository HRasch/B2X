...
- `.copilot-specs.md` - This file; AI assistant specifications and patterns

**Feature Documentation (Root Level):**
Each feature has ONE consolidated .md file:
- `ASPIRE_GUIDE.md` - Aspire/AppHost/orchestration configuration and setup
...
**Developer Tools (Root Level):**
- `DEBUG_QUICK_REFERENCE.md` - Quick lookup for debug configs and workflows
- `VSCODE_ASPIRE_CONFIG.md` - VS Code setup, launch configs, debugging
...
### 23.2 Documentation Guidelines

**When to Create/Update Documentation:**

1. **New Feature**: Create ONE consolidated `FEATURE_IMPLEMENTATION.md`
   - Include: API endpoints, models, validators, tests
   - Include: Usage examples, configuration
   - Reference: Link from this section
...
### 23.3 File Organization Rules

**Root Level Keeplist (Only these .md files):**
- README.md
- GETTING_STARTED.md
- DEVELOPMENT.md
...
**Everything Else:**
- Archive to `DOCS_ARCHIVE/` with date prefix
- Or consolidate into existing feature files

### 23.4 Implementation Checklist

When archiving/consolidating:

```
□ Create feature .md file with consolidated content
□ Update .copilot-specs.md Section 23 with reference
□ Create DOCS_ARCHIVE/ folder if needed
□ Move old files to DOCS_ARCHIVE/YYYY-MM-DD_FILENAME.md
□ Search codebase for file references, update if needed
□ Verify all important info is in new consolidated file
□ Git commit: "docs: consolidate [feature] documentation"
```

### 23.5 Why This Matters

- **Clarity**: Single source of truth per feature
- **Maintainability**: Less duplication, easier to update
- **Onboarding**: New developers know where to find info
- **Git**: Fewer files = cleaner history, easier diffs
- **Focus**: Less doc clutter = focus on code
...
**Maintainer**: B2Connect Team
**Latest Changes**: Added Documentation Structure (Section 23)
