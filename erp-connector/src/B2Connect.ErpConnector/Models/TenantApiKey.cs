...
namespace B2Connect.ErpConnector.Models
{
    /// <summary>
    ...
    /// These define what operations enventa Trade ERP can perform on B2Connect APIs.
    /// </summary>
    public enum ErpServicePermission
    {
        ...
        /// <summary>
        /// Receive webhook notifications for B2Connect events
        /// </summary>
        ReceiveWebhooks
    }
    ...
    public class TenantApiKey
    {
        ...
        // Even if B2Connect cloud is compromised, attackers cannot access ERP.
        ...
        /// to securely call B2Connect APIs for customer/product updates and usage statistics.
        /// </summary>
        public bool IsErpServiceAccount { get; set; } = false;

        /// <summary>
        /// ERP service account permissions (only applies when IsErpServiceAccount = true).
        /// Defines what operations the ERP system can perform on B2Connect APIs.
        /// </summary>
