<template>
  <div class="space-y-6">
    ...
    <div v-else-if="cmsStore.pages.length === 0" class="bg-white rounded-lg shadow p-8 text-center">
      <p class="text-gray-500">No pages yet. Create your first page to get started.</p>
    </div>
